         ...
         <footer className="px-4 pt-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
            <div className="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
               <div className="sm:col-span-2">
                  <h2 className="font-bold uppercase text-dark text-2xl">Gadget Haven</h2>
                  <div className="mt-6 lg:max-w-sm">
                     <p className="text-md text-gray-800">We provide tour packages around whole world for domestic and international tourists.</p>
                  </div>
               </div>
               <div className="space-y-2 text-sm">
                  ...
                  <div className="flex">
                     ...
                     <a className="transition-colors duration-300 text-deep-purple-accent-400 hover:text-deep-purple-800" href="#">+6282143261091</a>
                  </div>
                  <div className="flex">
                  ...
                  <div className="flex">
                     ...
                     <a href="#" target="_blank" rel="noopener noreferrer" aria-label="Our address" title="Our address" className="transition-colors duration-300 text-deep-purple-accent-400 hover:text-deep-purple-800">Lorem ipsum dolor sit amet consectetur adipisicing elit. Velit, beatae?
                     </a>
                  </div>
               </div>
               <div>
               ...
               <li>
               <a target="_blank" className="text-gray-700 transition hover:opacity-75" href="/">
               ...
               <p className="mt-4 text-sm text-gray-500">Follow us for the latest news and updates.</p>
               </div>
            </div>
